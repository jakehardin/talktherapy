"""
URL configuration for talktherapy project.
...
from talktherapyapi.views import register_user, check_user, UserView, CategoryView, TherapistView, ReviewView, AppointmentView
